...
class ProfileScreen(Screen):
    ...
    def submit_profile(self, instance):
        print(f"Profile submitted: Gender={self.gender.text}, Height={self.feet.text}ft {self.inches.text}in, Weight={self.weight.text}, Age={self.age.text}, Sport={self.sport.text}, Education={self.education.text}")
        self.manager.current = "home"
...
class HomeScreen(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.set_background()
        # Using your final HomeScreen layout
        ...
        def centered_row_button(text, fn):
            ...
            return row
        for action in ["Start Workout", "Log Stats", "View Trends", "Goals"]:
